...
public class ContactServiceSoapServiceLocator extends org.apache.axis.client.Service implements com.liferay.client.soap.portal.service.http.ContactServiceSoapService {
    ...
    private java.lang.String Portal_ContactService_address = "http://localhost:8080/tunnel-web/axis/Portal_ContactService";
    ...
    public com.liferay.client.soap.portal.service.http.ContactServiceSoap getPortal_ContactService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.liferay.client.soap.portal.service.http.Portal_ContactServiceSoapBindingStub _stub = new com.liferay.client.soap.portal.service.http.Portal_ContactServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.liferay.client.soap.portal.service.http.ContactServiceSoap.class.isAssignableFrom(serviceEndpointInterface)) {
                com.liferay.client.soap.portal.service.http.Portal_ContactServiceSoapBindingStub _stub = new com.liferay.client.soap.portal.service.http.Portal_ContactServiceSoapBindingStub(new java.net.URL(Portal_ContactService_address), this);
                _stub.setPortName(getPortal_ContactServiceWSDDServiceName());
                return _stub;
            }
        }
