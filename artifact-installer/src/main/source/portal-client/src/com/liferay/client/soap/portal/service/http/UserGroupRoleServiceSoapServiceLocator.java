...
public class UserGroupRoleServiceSoapServiceLocator extends org.apache.axis.client.Service implements com.liferay.client.soap.portal.service.http.UserGroupRoleServiceSoapService {
    ...
    private java.lang.String Portal_UserGroupRoleService_address = "http://localhost:8080/tunnel-web/axis/Portal_UserGroupRoleService";
    ...
    public com.liferay.client.soap.portal.service.http.UserGroupRoleServiceSoap getPortal_UserGroupRoleService() throws javax.xml.rpc.ServiceException {
    ...
    public com.liferay.client.soap.portal.service.http.UserGroupRoleServiceSoap getPortal_UserGroupRoleService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.liferay.client.soap.portal.service.http.Portal_UserGroupRoleServiceSoapBindingStub _stub = new com.liferay.client.soap.portal.service.http.Portal_UserGroupRoleServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.liferay.client.soap.portal.service.http.UserGroupRoleServiceSoap.class.isAssignableFrom(serviceEndpointInterface)) {
                com.liferay.client.soap.portal.service.http.Portal_UserGroupRoleServiceSoapBindingStub _stub = new com.liferay.client.soap.portal.service.http.Portal_UserGroupRoleServiceSoapBindingStub(new java.net.URL(Portal_UserGroupRoleService_address), this);
                _stub.setPortName(getPortal_UserGroupRoleServiceWSDDServiceName());
                return _stub;
            }
        }
