...
public class ExpandoValueServiceSoapServiceLocator extends org.apache.axis.client.Service implements com.liferay.client.soap.portlet.expando.service.http.ExpandoValueServiceSoapService {
    ...
    private java.lang.String Portlet_Expando_ExpandoValueService_address = "http://localhost:8080/tunnel-web/axis/Portlet_Expando_ExpandoValueService";
    ...
    public com.liferay.client.soap.portlet.expando.service.http.ExpandoValueServiceSoap getPortlet_Expando_ExpandoValueService() throws javax.xml.rpc.ServiceException {
    ...
    public com.liferay.client.soap.portlet.expando.service.http.ExpandoValueServiceSoap getPortlet_Expando_ExpandoValueService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.liferay.client.soap.portlet.expando.service.http.Portlet_Expando_ExpandoValueServiceSoapBindingStub _stub = new com.liferay.client.soap.portlet.expando.service.http.Portlet_Expando_ExpandoValueServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.liferay.client.soap.portlet.expando.service.http.ExpandoValueServiceSoap.class.isAssignableFrom(serviceEndpointInterface)) {
                com.liferay.client.soap.portlet.expando.service.http.Portlet_Expando_ExpandoValueServiceSoapBindingStub _stub = new com.liferay.client.soap.portlet.expando.service.http.Portlet_Expando_ExpandoValueServiceSoapBindingStub(new java.net.URL(Portlet_Expando_ExpandoValueService_address), this);
                _stub.setPortName(getPortlet_Expando_ExpandoValueServiceWSDDServiceName());
                return _stub;
            }
        }
