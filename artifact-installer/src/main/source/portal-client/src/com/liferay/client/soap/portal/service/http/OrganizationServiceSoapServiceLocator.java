...
public class OrganizationServiceSoapServiceLocator extends org.apache.axis.client.Service implements com.liferay.client.soap.portal.service.http.OrganizationServiceSoapService {
    ...
    private java.lang.String Portal_OrganizationService_address = "http://localhost:8080/tunnel-web/axis/Portal_OrganizationService";
    ...
    public com.liferay.client.soap.portal.service.http.OrganizationServiceSoap getPortal_OrganizationService() throws javax.xml.rpc.ServiceException {
    ...
    public com.liferay.client.soap.portal.service.http.OrganizationServiceSoap getPortal_OrganizationService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.liferay.client.soap.portal.service.http.Portal_OrganizationServiceSoapBindingStub _stub = new com.liferay.client.soap.portal.service.http.Portal_OrganizationServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.liferay.client.soap.portal.service.http.OrganizationServiceSoap.class.isAssignableFrom(serviceEndpointInterface)) {
                com.liferay.client.soap.portal.service.http.Portal_OrganizationServiceSoapBindingStub _stub = new com.liferay.client.soap.portal.service.http.Portal_OrganizationServiceSoapBindingStub(new java.net.URL(Portal_OrganizationService_address), this);
                _stub.setPortName(getPortal_OrganizationServiceWSDDServiceName());
                return _stub;
            }
        }
