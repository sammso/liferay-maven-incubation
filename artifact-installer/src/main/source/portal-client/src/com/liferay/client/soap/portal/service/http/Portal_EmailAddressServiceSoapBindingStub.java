/**
 * Portal_EmailAddressServiceSoapBindingStub.java
 *
...
public class Portal_EmailAddressServiceSoapBindingStub extends org.apache.axis.client.Stub implements com.liferay.client.soap.portal.service.http.EmailAddressServiceSoap {
    ...
    private static void _initOperationDesc1(){
        ...
        oper.addParameter(param);
        oper.setReturnType(new javax.xml.namespace.QName("urn:http.service.portal.liferay.com", "ArrayOf_tns2_EmailAddressSoap"));
        oper.setReturnClass(com.liferay.client.soap.portal.model.EmailAddressSoap[].class);
        oper.setReturnQName(new javax.xml.namespace.QName("", "getEmailAddressesReturn"));
        ...
        oper.addParameter(param);
        oper.setReturnType(new javax.xml.namespace.QName("http://model.portal.liferay.com", "EmailAddressSoap"));
        oper.setReturnClass(com.liferay.client.soap.portal.model.EmailAddressSoap.class);
        oper.setReturnQName(new javax.xml.namespace.QName("", "addEmailAddressReturn"));
        oper.setStyle(org.apache.axis.constants.Style.RPC);
        oper.setUse(org.apache.axis.constants.Use.ENCODED);
        _operations[1] = oper;
        ...
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("", "emailAddressId"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "long"), long.class, false, false);
        oper.addParameter(param);
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("", "address"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"), java.lang.String.class, false, false);
        oper.addParameter(param);
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("", "typeId"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "int"), int.class, false, false);
        ...
        oper = new org.apache.axis.description.OperationDesc();
        oper.setName("deleteEmailAddress");
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("", "emailAddressId"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "long"), long.class, false, false);
        oper.addParameter(param);
        ...
        oper.setReturnType(new javax.xml.namespace.QName("http://model.portal.liferay.com", "EmailAddressSoap"));
        oper.setReturnClass(com.liferay.client.soap.portal.model.EmailAddressSoap.class);
        oper.setReturnQName(new javax.xml.namespace.QName("", "getEmailAddressReturn"));
        oper.setStyle(org.apache.axis.constants.Style.RPC);
        oper.setUse(org.apache.axis.constants.Use.ENCODED);
        _operations[4] = oper;
    ...
    public Portal_EmailAddressServiceSoapBindingStub() throws org.apache.axis.AxisFault {
         this(null);
    }

    public Portal_EmailAddressServiceSoapBindingStub(java.net.URL endpointURL, javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
         this(service);
         super.cachedEndpoint = endpointURL;
    }

    public Portal_EmailAddressServiceSoapBindingStub(javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
        if (service == null) {
    ...
    public com.liferay.client.soap.portal.model.EmailAddressSoap[] getEmailAddresses(java.lang.String className, long classPK) throws java.rmi.RemoteException {
        ...
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("urn:http.service.portal.liferay.com", "getEmailAddresses"));
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {className, new java.lang.Long(classPK)});
        ...
        if (_resp instanceof java.rmi.RemoteException) {
            ...
            try {
                return (com.liferay.client.soap.portal.model.EmailAddressSoap[]) _resp;
            } catch (java.lang.Exception _exception) {
                return (com.liferay.client.soap.portal.model.EmailAddressSoap[]) org.apache.axis.utils.JavaUtils.convert(_resp, com.liferay.client.soap.portal.model.EmailAddressSoap[].class);
            }
        }
  ...
  throw axisFaultException;
    ...
    public com.liferay.client.soap.portal.model.EmailAddressSoap addEmailAddress(java.lang.String className, long classPK, java.lang.String address, int typeId, boolean primary) throws java.rmi.RemoteException {
        ...
        _call.setSOAPActionURI("");
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("urn:http.service.portal.liferay.com", "addEmailAddress"));

        setRequestHeaders(_call);
        setAttachments(_call);
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {className, new java.lang.Long(classPK), address, new java.lang.Integer(typeId), new java.lang.Boolean(primary)});
  ...
  throw axisFaultException;
    ...
    public com.liferay.client.soap.portal.model.EmailAddressSoap updateEmailAddress(long emailAddressId, java.lang.String address, int typeId, boolean primary) throws java.rmi.RemoteException {
        ...
        setRequestHeaders(_call);
        setAttachments(_call);
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {new java.lang.Long(emailAddressId), address, new java.lang.Integer(typeId), new java.lang.Boolean(primary)});
  ...
  throw axisFaultException;
    ...
    public void deleteEmailAddress(long emailAddressId) throws java.rmi.RemoteException {
        ...
        _call.setSOAPActionURI("");
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("urn:http.service.portal.liferay.com", "deleteEmailAddress"));

        setRequestHeaders(_call);
        setAttachments(_call);
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {new java.lang.Long(emailAddressId)});
  ...
  throw axisFaultException;
    ...
    public com.liferay.client.soap.portal.model.EmailAddressSoap getEmailAddress(long emailAddressId) throws java.rmi.RemoteException {
        ...
        _call.setSOAPActionURI("");
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("urn:http.service.portal.liferay.com", "getEmailAddress"));
