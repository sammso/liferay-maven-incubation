/**
 * Portlet_Bookmarks_BookmarksEntryServiceSoapBindingStub.java
 *
...
public class Portlet_Bookmarks_BookmarksEntryServiceSoapBindingStub extends org.apache.axis.client.Stub implements com.liferay.client.soap.portlet.bookmarks.service.http.BookmarksEntryServiceSoap {
    ...
    private static void _initOperationDesc1(){
        ...
        oper.addParameter(param);
        oper.setReturnType(new javax.xml.namespace.QName("http://model.bookmarks.portlet.liferay.com", "BookmarksEntrySoap"));
        oper.setReturnClass(com.liferay.client.soap.portlet.bookmarks.model.BookmarksEntrySoap.class);
        ...
        oper = new org.apache.axis.description.OperationDesc();
        oper.setName("openEntry");
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("", "entryId"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "long"), long.class, false, false);
        oper.addParameter(param);
        oper.setReturnType(new javax.xml.namespace.QName("http://model.bookmarks.portlet.liferay.com", "BookmarksEntrySoap"));
        oper.setReturnClass(com.liferay.client.soap.portlet.bookmarks.model.BookmarksEntrySoap.class);
        oper.setReturnQName(new javax.xml.namespace.QName("", "openEntryReturn"));
        oper.setStyle(org.apache.axis.constants.Style.RPC);
        oper.setUse(org.apache.axis.constants.Use.ENCODED);
        _operations[4] = oper;
    ...
    public Portlet_Bookmarks_BookmarksEntryServiceSoapBindingStub() throws org.apache.axis.AxisFault {
         this(null);
    }

    public Portlet_Bookmarks_BookmarksEntryServiceSoapBindingStub(java.net.URL endpointURL, javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
         this(service);
         super.cachedEndpoint = endpointURL;
    }

    public Portlet_Bookmarks_BookmarksEntryServiceSoapBindingStub(javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
        if (service == null) {
        ...
        ((org.apache.axis.client.Service)super.service).setTypeMappingVersion("1.2");
            ...
            qName = new javax.xml.namespace.QName("http://model.bookmarks.portlet.liferay.com", "BookmarksEntrySoap");
            cachedSerQNames.add(qName);
            cls = com.liferay.client.soap.portlet.bookmarks.model.BookmarksEntrySoap.class;
            ...
            qName = new javax.xml.namespace.QName("urn:http.service.bookmarks.portlet.liferay.com", "ArrayOf_xsd_string");
            cachedSerQNames.add(qName);
    ...
    public com.liferay.client.soap.portlet.bookmarks.model.BookmarksEntrySoap addEntry(long folderId, java.lang.String name, java.lang.String url, java.lang.String comments, com.liferay.client.soap.portal.service.ServiceContext serviceContext) throws java.rmi.RemoteException {
        ...
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("urn:http.service.bookmarks.portlet.liferay.com", "addEntry"));

        setRequestHeaders(_call);
        setAttachments(_call);
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {new java.lang.Long(folderId), name, url, comments, serviceContext});
        ...
        if (_resp instanceof java.rmi.RemoteException) {
            ...
            try {
                return (com.liferay.client.soap.portlet.bookmarks.model.BookmarksEntrySoap) _resp;
            } catch (java.lang.Exception _exception) {
                return (com.liferay.client.soap.portlet.bookmarks.model.BookmarksEntrySoap) org.apache.axis.utils.JavaUtils.convert(_resp, com.liferay.client.soap.portlet.bookmarks.model.BookmarksEntrySoap.class);
            }
        }
  ...
  throw axisFaultException;
    ...
    public com.liferay.client.soap.portlet.bookmarks.model.BookmarksEntrySoap getEntry(long entryId) throws java.rmi.RemoteException {
        ...
        _call.setSOAPActionURI("");
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("urn:http.service.bookmarks.portlet.liferay.com", "getEntry"));
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {new java.lang.Long(entryId)});
  ...
  throw axisFaultException;
    ...
    public void deleteEntry(long entryId) throws java.rmi.RemoteException {
        ...
        _call.setSOAPActionURI("");
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("urn:http.service.bookmarks.portlet.liferay.com", "deleteEntry"));
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {new java.lang.Long(entryId)});
  ...
  throw axisFaultException;
    ...
    public com.liferay.client.soap.portlet.bookmarks.model.BookmarksEntrySoap updateEntry(long entryId, long folderId, java.lang.String name, java.lang.String url, java.lang.String comments, com.liferay.client.soap.portal.service.ServiceContext serviceContext) throws java.rmi.RemoteException {
        ...
        _call.setSOAPActionURI("");
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("urn:http.service.bookmarks.portlet.liferay.com", "updateEntry"));

        setRequestHeaders(_call);
        setAttachments(_call);
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {new java.lang.Long(entryId), new java.lang.Long(folderId), name, url, comments, serviceContext});
  ...
  throw axisFaultException;
    ...
    public com.liferay.client.soap.portlet.bookmarks.model.BookmarksEntrySoap openEntry(long entryId) throws java.rmi.RemoteException {
        ...
        _call.setSOAPActionURI("");
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("urn:http.service.bookmarks.portlet.liferay.com", "openEntry"));
