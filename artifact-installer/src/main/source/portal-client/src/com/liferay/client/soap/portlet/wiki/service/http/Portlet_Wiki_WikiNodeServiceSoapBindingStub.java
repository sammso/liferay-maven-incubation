/**
 * Portlet_Wiki_WikiNodeServiceSoapBindingStub.java
 *
...
public class Portlet_Wiki_WikiNodeServiceSoapBindingStub extends org.apache.axis.client.Stub implements com.liferay.client.soap.portlet.wiki.service.http.WikiNodeServiceSoap {
    ...
    private static void _initOperationDesc1(){
        ...
        oper.addParameter(param);
        oper.setReturnType(new javax.xml.namespace.QName("http://model.wiki.portlet.liferay.com", "WikiNodeSoap"));
        oper.setReturnClass(com.liferay.client.soap.portlet.wiki.model.WikiNodeSoap.class);
        ...
        oper = new org.apache.axis.description.OperationDesc();
        oper.setName("getNode");
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("", "nodeId"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "long"), long.class, false, false);
        oper.addParameter(param);
        oper.setReturnType(new javax.xml.namespace.QName("http://model.wiki.portlet.liferay.com", "WikiNodeSoap"));
        oper.setReturnClass(com.liferay.client.soap.portlet.wiki.model.WikiNodeSoap.class);
        oper.setReturnQName(new javax.xml.namespace.QName("", "getNodeReturn"));
    ...
    public Portlet_Wiki_WikiNodeServiceSoapBindingStub() throws org.apache.axis.AxisFault {
         this(null);
    }

    public Portlet_Wiki_WikiNodeServiceSoapBindingStub(java.net.URL endpointURL, javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
         this(service);
         super.cachedEndpoint = endpointURL;
    }

    public Portlet_Wiki_WikiNodeServiceSoapBindingStub(javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
        if (service == null) {
        ...
        ((org.apache.axis.client.Service)super.service).setTypeMappingVersion("1.2");
            ...
            cachedSerQNames.add(qName);
            cls = com.liferay.client.soap.portlet.wiki.model.WikiNodeSoap.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            qName = new javax.xml.namespace.QName("urn:http.service.wiki.portlet.liferay.com", "ArrayOf_xsd_string");
            cachedSerQNames.add(qName);
    ...
    public com.liferay.client.soap.portlet.wiki.model.WikiNodeSoap addNode(java.lang.String name, java.lang.String description, com.liferay.client.soap.portal.service.ServiceContext serviceContext) throws java.rmi.RemoteException {
        ...
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("urn:http.service.wiki.portlet.liferay.com", "addNode"));

        setRequestHeaders(_call);
        setAttachments(_call);
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {name, description, serviceContext});
        ...
        if (_resp instanceof java.rmi.RemoteException) {
            ...
            try {
                return (com.liferay.client.soap.portlet.wiki.model.WikiNodeSoap) _resp;
            } catch (java.lang.Exception _exception) {
                return (com.liferay.client.soap.portlet.wiki.model.WikiNodeSoap) org.apache.axis.utils.JavaUtils.convert(_resp, com.liferay.client.soap.portlet.wiki.model.WikiNodeSoap.class);
            }
        }
  ...
  throw axisFaultException;
    ...
    public com.liferay.client.soap.portlet.wiki.model.WikiNodeSoap getNode(long groupId, java.lang.String name) throws java.rmi.RemoteException {
        ...
        _call.setSOAPActionURI("");
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("urn:http.service.wiki.portlet.liferay.com", "getNode"));

        setRequestHeaders(_call);
        setAttachments(_call);
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {new java.lang.Long(groupId), name});
  ...
  throw axisFaultException;
    ...
    public com.liferay.client.soap.portlet.wiki.model.WikiNodeSoap getNode(long nodeId) throws java.rmi.RemoteException {
        ...
        setRequestHeaders(_call);
        setAttachments(_call);
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {new java.lang.Long(nodeId)});
  ...
  throw axisFaultException;
    ...
    public void deleteNode(long nodeId) throws java.rmi.RemoteException {
        ...
        _call.setSOAPActionURI("");
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("urn:http.service.wiki.portlet.liferay.com", "deleteNode"));
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {new java.lang.Long(nodeId)});
  ...
  throw axisFaultException;
    ...
    public void subscribeNode(long nodeId) throws java.rmi.RemoteException {
        ...
        _call.setSOAPActionURI("");
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("urn:http.service.wiki.portlet.liferay.com", "subscribeNode"));
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {new java.lang.Long(nodeId)});
  ...
  throw axisFaultException;
    ...
    public void unsubscribeNode(long nodeId) throws java.rmi.RemoteException {
        ...
        _call.setSOAPActionURI("");
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("urn:http.service.wiki.portlet.liferay.com", "unsubscribeNode"));
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {new java.lang.Long(nodeId)});
  ...
  throw axisFaultException;
    ...
    public com.liferay.client.soap.portlet.wiki.model.WikiNodeSoap updateNode(long nodeId, java.lang.String name, java.lang.String description, com.liferay.client.soap.portal.service.ServiceContext serviceContext) throws java.rmi.RemoteException {
        ...
        _call.setSOAPActionURI("");
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("urn:http.service.wiki.portlet.liferay.com", "updateNode"));

        setRequestHeaders(_call);
        setAttachments(_call);
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {new java.lang.Long(nodeId), name, description, serviceContext});
  ...
  throw axisFaultException;
    ...
    public com.liferay.client.soap.portlet.wiki.model.WikiNodeSoap updateNode(long nodeId, java.lang.String name, java.lang.String description) throws java.rmi.RemoteException {
        ...
        setRequestHeaders(_call);
        setAttachments(_call);
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {new java.lang.Long(nodeId), name, description});
