/**
 * Portlet_Bookmarks_BookmarksFolderServiceSoapBindingStub.java
 *
...
public class Portlet_Bookmarks_BookmarksFolderServiceSoapBindingStub extends org.apache.axis.client.Stub implements com.liferay.client.soap.portlet.bookmarks.service.http.BookmarksFolderServiceSoap {
    ...
    private static void _initOperationDesc1(){
        ...
        oper.setReturnType(new javax.xml.namespace.QName("http://model.bookmarks.portlet.liferay.com", "BookmarksFolderSoap"));
        oper.setReturnClass(com.liferay.client.soap.portlet.bookmarks.model.BookmarksFolderSoap.class);
    ...
    public Portlet_Bookmarks_BookmarksFolderServiceSoapBindingStub() throws org.apache.axis.AxisFault {
         this(null);
    }

    public Portlet_Bookmarks_BookmarksFolderServiceSoapBindingStub(java.net.URL endpointURL, javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
         this(service);
         super.cachedEndpoint = endpointURL;
    }

    public Portlet_Bookmarks_BookmarksFolderServiceSoapBindingStub(javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
        if (service == null) {
        ...
        ((org.apache.axis.client.Service)super.service).setTypeMappingVersion("1.2");
            ...
            qName = new javax.xml.namespace.QName("http://model.bookmarks.portlet.liferay.com", "BookmarksFolderSoap");
            cachedSerQNames.add(qName);
            cls = com.liferay.client.soap.portlet.bookmarks.model.BookmarksFolderSoap.class;
    ...
    public com.liferay.client.soap.portlet.bookmarks.model.BookmarksFolderSoap getFolder(long folderId) throws java.rmi.RemoteException {
        ...
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("urn:http.service.bookmarks.portlet.liferay.com", "getFolder"));
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {new java.lang.Long(folderId)});
        ...
        if (_resp instanceof java.rmi.RemoteException) {
            ...
            try {
                return (com.liferay.client.soap.portlet.bookmarks.model.BookmarksFolderSoap) _resp;
            } catch (java.lang.Exception _exception) {
                return (com.liferay.client.soap.portlet.bookmarks.model.BookmarksFolderSoap) org.apache.axis.utils.JavaUtils.convert(_resp, com.liferay.client.soap.portlet.bookmarks.model.BookmarksFolderSoap.class);
            }
        }
  ...
  throw axisFaultException;
    ...
    public com.liferay.client.soap.portlet.bookmarks.model.BookmarksFolderSoap addFolder(long parentFolderId, java.lang.String name, java.lang.String description, com.liferay.client.soap.portal.service.ServiceContext serviceContext) throws java.rmi.RemoteException {
        ...
        _call.setSOAPActionURI("");
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("urn:http.service.bookmarks.portlet.liferay.com", "addFolder"));
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {new java.lang.Long(parentFolderId), name, description, serviceContext});
  ...
  throw axisFaultException;
    ...
    public void deleteFolder(long folderId) throws java.rmi.RemoteException {
        ...
        _call.setSOAPActionURI("");
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("urn:http.service.bookmarks.portlet.liferay.com", "deleteFolder"));
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {new java.lang.Long(folderId)});
  ...
  throw axisFaultException;
    ...
    public com.liferay.client.soap.portlet.bookmarks.model.BookmarksFolderSoap updateFolder(long folderId, long parentFolderId, java.lang.String name, java.lang.String description, boolean mergeWithParentFolder, com.liferay.client.soap.portal.service.ServiceContext serviceContext) throws java.rmi.RemoteException {
        ...
        _call.setSOAPActionURI("");
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("urn:http.service.bookmarks.portlet.liferay.com", "updateFolder"));
