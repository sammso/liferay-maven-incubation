...
public class ResourcePermissionServiceSoapServiceLocator extends org.apache.axis.client.Service implements com.liferay.client.soap.portal.service.http.ResourcePermissionServiceSoapService {
    ...
    private java.lang.String Portal_ResourcePermissionService_address = "http://localhost:8080/tunnel-web/axis/Portal_ResourcePermissionService";
    ...
    public com.liferay.client.soap.portal.service.http.ResourcePermissionServiceSoap getPortal_ResourcePermissionService() throws javax.xml.rpc.ServiceException {
    ...
    public com.liferay.client.soap.portal.service.http.ResourcePermissionServiceSoap getPortal_ResourcePermissionService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.liferay.client.soap.portal.service.http.Portal_ResourcePermissionServiceSoapBindingStub _stub = new com.liferay.client.soap.portal.service.http.Portal_ResourcePermissionServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.liferay.client.soap.portal.service.http.ResourcePermissionServiceSoap.class.isAssignableFrom(serviceEndpointInterface)) {
                com.liferay.client.soap.portal.service.http.Portal_ResourcePermissionServiceSoapBindingStub _stub = new com.liferay.client.soap.portal.service.http.Portal_ResourcePermissionServiceSoapBindingStub(new java.net.URL(Portal_ResourcePermissionService_address), this);
                _stub.setPortName(getPortal_ResourcePermissionServiceWSDDServiceName());
                return _stub;
            }
        }
